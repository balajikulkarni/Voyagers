...
void loop(){
	...
	TCP_message.toCharArray(message_TCP, 300);
    ...
    if (sendATcommand2("AT+CIPMUX=0", "OK", "ERROR", 1000) == 1)
    {
        ...
        if (sendATcommand2("AT+CSTT="airtelgprs.com","",""", "OK",  "ERROR", 2000) == 1)
        {
            ...
            if (sendATcommand2("AT+CIICR", "OK", "ERROR", 2000) == 1)
            {
                ...
                if (sendATcommand2("AT+CIFSR", ".", "ERROR", 10000) == 1)
                {
                    ...
                    // Opens a TCP socket
                    if (sendATcommand2("AT+CIPSTART="TCP","api.xively.com","8081"",
